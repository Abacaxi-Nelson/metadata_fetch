...
void main() {
  ...
  group('extract()', () {
    test('First Test', () async {
      var data = await (extract('https://flutter.dev/') as FutureOr<Metadata>);
      print(data);
    ...
    test('FB Test', () async {
      var data = await (extract('https://facebook.com/') as FutureOr<Metadata>);
      expect(data.toMap().isEmpty, false);
    });
    ...
    test('Unicode Test', () async {
      var data =
          await (extract('https://www.jpf.go.jp/') as FutureOr<Metadata>);
      expect(data.toMap().isEmpty, false);
    });

    test('Gooogle Test', () async {
      var data = await (extract('https://google.ca') as FutureOr<Metadata>);
      expect(data.toMap().isEmpty, false);
